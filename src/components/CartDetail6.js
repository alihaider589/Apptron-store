...
export default class CartDetail6 extends Component {
    state = {
  ...
  render() {
    return (
      <View>
           ...
           <ImageBackground source={White} style={{width:Dimensions.get('window').width,height:Dimensions.get('window').height}}>
