...
export default class CartDetail7 extends Component {
    state = {
  ...
  render() {
    return (
      <View>
           ...
           <ImageBackground source={WhiteSecond} style={{width:Dimensions.get('window').width,height:Dimensions.get('window').height}}>
