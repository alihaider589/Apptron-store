...
export default class CartDetail4 extends Component {
    state = {
  ...
  render() {
    return (
      <View>
           ...
           <ImageBackground source={Green} style={{width:Dimensions.get('window').width,height:Dimensions.get('window').height}}>
